      ...
      <Dialog open={reportPreviewOpen} onOpenChange={setReportPreviewOpen}>
        <DialogContent className="sm:max-w-[900px] max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Preview of your population health analytics report
            </DialogDescription>
          </DialogHeader>
            ...
            <div>
              ...
              <div className="h-[200px] bg-gray-100 rounded-md p-3 flex items-center justify-center mb-4">
                <div className="text-center">
                  <span className="block text-gray-400 mb-2">Community Health Comparison Chart</span>
                  <div className="flex items-end gap-3 h-24">
                    {communityEngagement.map((community, i) => (
                      <div key={i} className="flex flex-col items-center">
                        <div className="bg-blue-500 w-10" style={{ height: `${community.engagement * 0.3}px` }}></div>
                        <span className="text-xs mt-1">{community.name}</span>
                      </div>
                    ))}
                  </div>
                </div>
                    ...
                    {reportData?.nextSteps.map((step, i) => (
                      <div key={i} className="border rounded-md p-4 bg-muted/40">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-1 md:gap-4 text-xs text-muted-foreground">
                          ...
                          <span>Resources: {step.resources}</span>
                        </div>
                      </div>
                    ))}
                  </div>
